...
LIBMAPLE_MODULES += $(SRCROOT)/libraries/LCD3310
LIBMAPLE_MODULES += $(SRCROOT)/libraries/SdFat
LIBMAPLE_MODULES += $(SRCROOT)/libraries/PP_Ext
#LIBMAPLE_MODULES += $(SRCROOT)/libraries/RTC
LIBMAPLE_MODULES += $(SRCROOT)/libraries/Wire
#LIBMAPLE_MODULES += $(SRCROOT)/libraries/Rtc_Pcf8563
#LIBMAPLE_MODULES += $(SRCROOT)/libraries/MOD_IO2
LIBMAPLE_MODULES += $(SRCROOT)/libraries/mag3110
LIBMAPLE_MODULES += $(SRCROOT)/libraries/ds1337
